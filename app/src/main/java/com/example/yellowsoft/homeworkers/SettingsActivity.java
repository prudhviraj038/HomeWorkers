...
public class SettingsActivity extends Activity {
    ...
    LinearLayout lang_btn,profile_btn,logout_btn,contact_btn,about_btn;
    int MY_PERMISSIONS_REQUEST_CALL_PHONE;
    TextView st_name,st_lang,st_settings,st_profile,st_logout,st_support,st_contact,st_about,st_contactus;
    @Override
